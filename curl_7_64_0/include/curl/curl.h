...
#define CURLOPT_SERVER_RESPONSE_TIMEOUT CURLOPT_FTP_RESPONSE_TIMEOUT
  ...
  */
  ...
  /* 1C Modify: disable POST optimization (Content-Length: 0) with authentication */
  CINIT(1C_DISABLE_POST_AUTH_OPTIMIZATION, LONG, 270),

#ifdef USE_OPENSSL
  /* 1C Modify: Send TLS_FALLBACK_SCSV in the ClientHello*/
  CINIT(1C_CURLOPT_SSL_SEND_FALLBACK_SCSV, LONG, 271),
#endif
