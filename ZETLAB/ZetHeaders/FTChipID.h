...
#define FTCHIPID_IS_DLL
#define FTCHIPID_API __declspec(dllexport)
#elif defined(FTCHIPID_IMPORTS)
#define FTCHIPID_IS_DLL
...
#if !defined (FTCHIPID_IS_DLL) || defined (LINUX)

FTCHIPID_API
BOOL WINAPI FTID_Constructor();

FTCHIPID_API
BOOL WINAPI FTID_Destructor();
...
#if !defined (LINUX) && !defined(_WIN32_WCE)
FTCHIPID_API
