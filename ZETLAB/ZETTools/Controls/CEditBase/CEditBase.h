...
/*************************************************************************************************
	...
	1) возможность отобразить всплывающее сообщение (функция ShowBuble)
	2) установка ToolTip
...
public:	//*****************************************************************************************
	...
	LRESULT ShowBuble(_In_ CString sTitle, _In_ CString sText, _In_opt_ INT Icon = TTI_ERROR);
	LRESULT HideBuble();		// спрятать всплывающее сообщение
	//*********************************************************************************************
