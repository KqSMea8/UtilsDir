...
#include "afxwin.h"
#include <utility>
#include <Controls/CEditBase/CEditBase.h>
/*************************************************************************************************
...
public:	//*****************************************************************************************
	...
	CMySpinCtrl *GetSpinCtrl() { return m_SpinCtrl; }	// получаем указатель на спинконтрол
	//*********************************************************************************************
...
private://*****************************************************************************************
	...
	void ReposCtrl(_In_opt_ const CRect &NewRect = CRect());	// перемасштабирование контрола	
private://*****************************************************************************************
	CMySpinCtrl *m_SpinCtrl;		// экземпляр спин контрола
