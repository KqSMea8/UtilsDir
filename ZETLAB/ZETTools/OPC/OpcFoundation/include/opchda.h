...
#define OPCHDA_EXTRADATA 0x00010000
#define OPCHDA_INTERPOLATED 0x00020000
#define OPCHDA_RAW 0x00040000
#define OPCHDA_CALCULATED 0x00080000
#define OPCHDA_NOBOUND 0x00100000
#define OPCHDA_NODATA 0x00200000
#define OPCHDA_DATALOST 0x00400000
#define OPCHDA_CONVERSION 0x00800000
#define OPCHDA_PARTIAL 0x01000000
...
EXTERN_C const IID IID_IOPCHDA_SyncRead;
    ...
    public:
        ...
        virtual HRESULT STDMETHODCALLTYPE ReadProcessed( 
            ...
            /* [in] */ DWORD dwNumItems,
            /* [size_is][in] */ OPCHANDLE __RPC_FAR *phServer,
            /* [size_is][in] */ DWORD __RPC_FAR *haAggregate,
            /* [size_is][size_is][out] */ OPCHDA_ITEM __RPC_FAR *__RPC_FAR *ppItemValues,
            /* [size_is][size_is][out] */ HRESULT __RPC_FAR *__RPC_FAR *ppErrors) = 0;
