...
FRL_EXCEPTION_CLASS( UnableSetWriteTimeouts );
FRL_EXCEPTION_CLASS( UnableGetWriteTimeouts );
...
enum WriteTimeout
{
	WRITE_TIMEOUT_UNKNOWN		= -1,	// Unknown
	WRITE_TIMEOUT_NON_BLOCK		=  0,	// Always return immediately
	WRITE_TIMEOUT_BLOCK			=  1	// Block until everything is retrieved
};
...
enum BaudRate
{
	...
	BAUD_RATE_921600  = 921600,		// 921600 bits/sec
...
void setWriteTimeouts( SerialPortDescriptor handle, WriteTimeout timeOutType );
